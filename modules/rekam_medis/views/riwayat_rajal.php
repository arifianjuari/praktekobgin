<?php
// Riwayat Rajal (duplikat dari Daftar Atensi)
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <form method="GET" class="d-flex gap-2">
                                ...
                                <input type="hidden" name="action" value="riwayat_rajal">
                                ...
                                <?php if (!empty($status_filter)): ?>
                                    <a href="index.php?module=rekam_medis&action=riwayat_rajal" class="btn btn-secondary">
