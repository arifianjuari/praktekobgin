                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="mb-2">
                                    ...
                                    <textarea name="keluhan_utama" class="form-control form-control-sm auto-resize" rows="2" style="overflow-y: hidden; resize: none;" oninput="this.style.height='auto';this.style.height=this.scrollHeight+'px';"><?= isset($pemeriksaan['keluhan_utama']) ? $pemeriksaan['keluhan_utama'] : '' ?></textarea>
                                </div>
                                <div class="mb-2">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-2">
                                    ...
                                    <textarea name="ket_fisik" class="form-control form-control-sm auto-resize" rows="2" style="overflow-y: hidden; resize: none;" oninput="this.style.height='auto';this.style.height=this.scrollHeight+'px';"><?= isset($pemeriksaan['ket_fisik']) ? $pemeriksaan['ket_fisik'] : '' ?></textarea>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Auto-resize for all textareas with class 'auto-resize'
