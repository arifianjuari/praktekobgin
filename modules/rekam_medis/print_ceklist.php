...
if (!isset($_GET['isi']) || trim($_GET['isi']) === '') {
    die("Tidak ada data ceklist yang diberikan.");
}

// Dapatkan data dari parameter
$isiCeklist = trim($_GET['isi']);
...
$contentWidth = 98; // 100mm - 1mm margin kiri - 1mm margin kanan
...
$tempPdf->Cell(0, 6, 'CEKLIST', 0, 1, 'C');
...
// Output PDF
$pdf->Output('ceklist_pasien_' . $noRm . '.pdf', 'I'); // I untuk inline view, D untuk download
